...
const pageMeta = {
  ...
  '/subscription-ab-reviews': { title: 'اشتراك حاسبات وهندسة - ابلكيشن معادلة كلية هندسة', description: 'تفاصيل اشتراك حاسبات وهندسة والمحتوى التعليمي المتاح للطلاب.', image: '/assets/logo.png' },
  '/subscription-computers': { title: 'اشتراك حاسبات - ابلكيشن معادلة كلية هندسة', description: 'اشترك في محتوى حاسبات المنظم والمناسب لطلاب المعادلة.', image: '/assets/logo.png' },
