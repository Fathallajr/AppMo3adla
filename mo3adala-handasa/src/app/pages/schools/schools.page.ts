...
export class SchoolsPageComponent {
  ...
  filterOptions = [
    'الكل',
    'المعاهد',
    'معهد فني صناعي 3 سنين',
    'معهد فني صناعي 5 سنين',
    'مدارس تكنولوجية'
  ];
  ...
  allSchools = [
    {
      id: 1,
      name: 'المعهد الفني الصناعي القاهرة',
      type: 'معهد فني صناعي 3 سنين',
      category: 'معهد فني صناعي 3 سنين',
    ...
    {
      id: 2,
      name: 'المعهد الفني الصناعي الإسكندرية',
      type: 'معهد فني صناعي 5 سنين',
      category: 'معهد فني صناعي 5 سنين',
    ...
    {
      id: 13,
      name: 'مدرسة القاهرة التكنولوجية',
      type: 'مدرسة تكنولوجية',
      category: 'مدارس تكنولوجية',
      logo: '/assets/schools/tech-school.png',
      description: 'مدرسة حديثة متخصصة في التكنولوجيا',
      programs: ['برمجة', 'شبكات', 'ذكاء اصطناعي'],
      established: '2020',
      students: '1500+'
    },
    {
      id: 14,
      name: 'المعهد العالي للهندسة التطبيقية',
      type: 'معهد عالي',
      category: 'المعاهد',
      logo: '/assets/schools/applied-engineering.png',
      description: 'معهد عالي للهندسة التطبيقية',
      programs: ['هندسة تطبيقية', 'هندسة صناعية', 'هندسة بيئية'],
      established: '1985',
      students: '2800+'
    },
    {
      id: 15,
      name: 'مدرسة الجيزة التكنولوجية المتقدمة',
      type: 'مدرسة تكنولوجية',
      category: 'مدارس تكنولوجية',
      logo: '/assets/schools/giza-tech.png',
      description: 'مدرسة تكنولوجية متقدمة بالجيزة',
      programs: ['روبوتيكس', 'إنترنت الأشياء', 'تصميم رقمي'],
      established: '2019',
      students: '1200+'
    },
    {
  ...
  get schools() {
    ...
    if (this.selectedFilter !== 'الكل') {
      filteredSchools = filteredSchools.filter(school => {
        if (this.selectedFilter === 'المعاهد') {
          return school.category === 'المعاهد' || school.category.includes('معهد');
        }
    ...
    if (this.searchTerm.trim()) {
      ...
      filteredSchools = filteredSchools.filter(school =>
        ...
        school.programs.some(program => program.toLowerCase().includes(term))
      );
    }
  ...
  getCountByCategory(category: string): number {
    if (category === 'المعاهد') {
      return this.allSchools.filter(school => 
        school.category === 'المعاهد' || school.category.includes('معهد')
      ).length;
    }
