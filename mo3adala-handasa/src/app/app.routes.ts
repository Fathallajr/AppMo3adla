...
export const routes: Routes = [
	...
	{ path: 'subscription-details', redirectTo: 'subscription-engineer', pathMatch: 'full' },
	{ path: 'subscription-ab-reviews', redirectTo: 'subscription-engineer', pathMatch: 'full' },
	{ path: 'subscription-engineer', loadComponent: () => import('./pages/subscription-ab-reviews/subscription-ab-reviews.page').then(m => m.SubscriptionAbReviewsPageComponent) },
	{ path: 'subscription-computers', loadComponent: () => import('./pages/subscription-ab-reviews/subscription-ab-reviews.page').then(m => m.SubscriptionAbReviewsPageComponent) },
